...
resource "cloudflare_record" "aws_ses_dkim_1" {
  ...
  value   = "z3i3pfmu2dtqouuammskg26x7dmtvwg2.dkim.amazonses.com"
}
...
resource "cloudflare_record" "aws_ses_dkim_2" {
  ...
  value   = "xcflhuf6od73o7exz4rr5dcnbfrkyeji.dkim.amazonses.com"
}
...
resource "cloudflare_record" "aws_ses_dkim_3" {
  ...
  value   = "c2kpj7rmffsop7u7pz5nmdprejc4nn6k.dkim.amazonses.com"
}
...
resource "cloudflare_record" "aws_ses_home_dkim_1" {
  ...
  value   = "f45iq4empt6l4pbhsn3y7qsudbxm2wyn.dkim.amazonses.com"
}
...
resource "cloudflare_record" "aws_ses_home_dkim_2" {
  ...
  value   = "2gmhp2fdzrhb7ykkxxb4gad46de22q6g.dkim.amazonses.com"
}
...
resource "cloudflare_record" "aws_ses_home_dkim_3" {
  ...
  value   = "xhdln6bsdm5rcln5a5c5t3imn2znovbk.dkim.amazonses.com"
}
