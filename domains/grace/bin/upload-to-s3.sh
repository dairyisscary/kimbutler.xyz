...
aws s3 cp --recursive --metadata-directive REPLACE --content-type "text/html; charset=utf-8" --cache-control "$BROWSER_EXPIRES" --exclude "*" --include "*.html" --include "*.png" --include "*manifest.json" --include "*.ico" public "s3://$BUCKET_NAME"
